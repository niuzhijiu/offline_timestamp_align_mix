...
int main() {
    // 数据文件路径
    std::string imu_csv_path = "/home/cat/foxy_education_data/imu0_data_w_norm.csv";
    std::string vis_csv_path = "/home/cat/foxy_education_data/visual_angular_velocity_mid_cpp.csv";
