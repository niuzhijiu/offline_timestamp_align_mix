...
int main() {
    ...
    // 输入输出文件路径
    std::string cam_csv = "/home/cat/noetic_education_data/cam0_timestamp.csv";
    std::string cam_aligned_csv = "/home/cat/noetic_education_data/cam0_aligned.csv";
