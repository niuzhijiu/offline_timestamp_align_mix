...
int main() {
    // 数据文件路径
    std::string imu_csv_path = "/home/cat/noetic_education_data/imu0_data_w_norm.csv";
    std::string vis_csv_path = "/home/cat/noetic_education_data/visual_angular_velocity_mid_cpp.csv";
    ...
    // 搜索最佳时间偏移，范围-25ms至+25ms，步长0.5ms
