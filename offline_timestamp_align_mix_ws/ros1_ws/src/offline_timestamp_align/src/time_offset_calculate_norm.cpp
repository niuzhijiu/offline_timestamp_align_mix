...
int main() {
    //数据文件路径
    std::string imu_csv_path = "/home/slam/20251212_ros1/imu0_data_w_norm.csv";
    std::string vis_csv_path = "/home/slam/20251212_ros1/visual_angular_velocity_mid_cpp.csv";
